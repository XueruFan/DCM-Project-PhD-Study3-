...
% Classic rDCM and rDCM with sparsity
...
%     rDCM variant: 1 = original, 2 = with sparsity constraints
...
out_path  = fullfile(data_root, 'srDCM');
...
%     rDCM variant: 1 = original, 2 = with sparsity constraints
    ...
    out_fn = sprintf('%s_DU15_srDCM.mat', subName);
    save(fullfile(out_path, out_fn),'EC', 'siteName', 'subName', 'TR');
